...
def optimize_forest_nodes(X_train,y_train, mycv):
    ...
    param_dist = {
    'kernel':['linear'],# ['linear', 'poly', 'rbf', 'sigmoid'] ,#[2,4,8,16,32,64,128],
    'degree':[2],#[2,3,4,5],# [50,150,200],#[20,50,100,150,200],
    'gamma': ['scale'],#['scale', 'auto'],#[0.001,0.01,0.05,0.1,0.2,0.3],
    'C':[0.1],#[0.1,0.5,1,2],#[0.5,0.6,0.7,0.8,0.9,1],
    'epsilon':[0.1],#[0.05,0.1,0.2,1,2],#[0.5,0.6,0.7,0.8,0.9,1],
...
for random_number in [100]:#,2024,800,500,705,2023,2005,208,803,42,36]:
    ...
    regr = SVR(kernel = 'linear',degree=2, gamma='scale', C = 0.1, epsilon = 0.1,shrinking = True )
    k = 5
